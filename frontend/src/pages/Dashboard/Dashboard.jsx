  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 min-h-screen text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        {/* Top-Right: Total Requests Sent Metric Card (4 cols) */}
        <div className="lg:col-span-4 self-end">
          <div className="bg-white border border-gray-100 p-6 rounded-2xl shadow-2xs flex flex-col justify-between h-[218px]">
            <div>
              <p className="text-sm font-semibold text-gray-900">
                Total requests sent
              </p>
              <h2 className="text-3xl font-extrabold text-gray-900 mt-2 font-mono">
                {userRequests.length}
              </h2>
            </div>
            ...
            <div className="w-full h-12 mt-4">
              ...
              >
                <path
                  d="M0,22 Q15,18 25,20 T50,12 T75,18 T100,8"
                  fill="none"
                  stroke="#4f46e5"
                  strokeWidth="2.5"
                  strokeLinecap="round"
